...
/**
 * Helper class for showing and canceling warning
 * notifications.
 * <p>
...
public class WarningNotification {
     ...
     * presentation of warning notifications. Make
     * sure to follow the
     ...
     * @see #cancel(Context)
     */
    public static void notify(final Context context, String channel) {
        final Resources res = context.getResources();

        // This image is used as the notification's large icon (thumbnail).
        final Bitmap picture = BitmapFactory.decodeResource(res, R.mipmap.ic_launcher);

        final String title = "Warning from SmartBasha";
        final String text = "Your Light is ON for no reason!!";
